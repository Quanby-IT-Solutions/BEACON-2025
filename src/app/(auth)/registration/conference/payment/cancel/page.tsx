    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="max-w-2xl w-full space-y-6">
        ...
        <Card className="border-orange-200 bg-orange-50">
          ...
          <CardContent className="text-center">
            <p className="text-orange-700">
              Your payment was cancelled and your registration has not been completed.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <Alert>
              ...
              <AlertDescription>
                Don't worry! Your registration information has been saved. You can continue from where you left off.
              </AlertDescription>
            </Alert>
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-start gap-2">
                ...
                <span>Return to the registration form to complete your payment</span>
              </div>
              <div className="flex items-start gap-2">
                <div className="w-2 h-2 bg-blue-600 rounded-full mt-2" />
                <span>Try a different payment method if the previous one didn't work</span>
              </div>
              <div className="flex items-start gap-2">
                <div className="w-2 h-2 bg-blue-600 rounded-full mt-2" />
                <span>Contact support if you're experiencing technical difficulties</span>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-blue-200 bg-blue-50">
          <CardHeader>
            <CardTitle className="text-base text-blue-800">Available Payment Methods</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <div className="text-center">
                ...
                <p className="text-blue-700">Instant payment via GCash wallet</p>
              </div>
              <div className="text-center">
                <div className="bg-white rounded-lg p-3 mb-2">
                  <span className="font-medium text-blue-800">Bank Transfer</span>
                </div>
                <p className="text-blue-700">Online banking or over-the-counter</p>
              </div>
              <div className="text-center">
                <div className="bg-white rounded-lg p-3 mb-2">
        ...
        <Card className="border-gray-200 bg-gray-50">
          <CardContent className="pt-6 text-center">
            <p className="text-sm text-gray-700">
              ...
              <a href="mailto:support@beacon2025.com" className="underline text-blue-600">
